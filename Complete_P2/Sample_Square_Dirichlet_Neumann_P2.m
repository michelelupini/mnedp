...
if(exist('/Users/michelelupini/Desktop/Esercitazioni/Progetto/bbtr30'))
     addpath('/Users/michelelupini/Desktop/Esercitazioni/Progetto/bbtr30')
     disp('/Users/michelelupini/Desktop/Esercitazioni/Progetto/bbtr30 added to the path')
end
...
BC.Boundary.Values = [1 2 3 5];
% marker dei Vertici iniziali
BC.InputVertexValues = [6 7 8 9];
...
RefiningOptions.AreaValue  = Refining_Area(iter);
